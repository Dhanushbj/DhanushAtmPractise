...
namespace ShoppingAssignment
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            list.Add(new Category { id = 3, category = "LAPTOPS", product = "Apple", price = 125000.0 });
            list.Add(new Category { id = 3, category = "LAPTOPS", product = "Lenovo", price = 50000.0 });
            list.Add(new Category { id = 3, category = "LAPTOPS", product = "Dell", price = 40000.0 });
            list.Add(new Category { id = 3, category = "Grocery", product = "Rice", price = 400.0 });
            list.Add(new Category { id = 3, category = "Grocery", product = "Wheat", price = 800.0 });
